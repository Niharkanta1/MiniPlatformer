...
namespace Editor
{
    public static class CreateClasses
    {
        ...
        [MenuItem(itemName: "Assets/Create/Script/C# Unity Script", isValidateFunction: false, priority: 50)]
        ...
        [MenuItem(itemName: "Assets/Create/Script/C# Unity Singleton Script", isValidateFunction: false, priority: 50)]
